...
description: "npm's registry and CLI allow dots in scope names, but PowerShell on Windows fails to parse them unless the name is wrapped in (single) quotes. Despite this, the install command shown on npmjs.com omits the quotes, leading to immediate errors for Windows users who copy‑paste the official command."
keywords: ''
...
<div align="center">
  <img
    width="1243"
    height="509"
    alt="Screenshot by Igor Dimitrijević (igorskyflyer)"
    src="https://github.com/user-attachments/assets/a95ba0d6-334d-4a0e-9810-af3883c09007"
  />
  <em>
    <strong>Figure 1.</strong> Screenshot of the PowerShell exception followed
